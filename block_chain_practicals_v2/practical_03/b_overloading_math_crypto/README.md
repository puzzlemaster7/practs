# Practical 3(b): Function Overloading + Math + Crypto
...
- Cryptographic hash functions (`keccak256`, `sha256`, `ripemd160`)

## Description
Demonstrates overloaded functions and common on-chain hashing utilities.
...
**Terminal 1**
```powershell
cd G:\block_chain_practicals\practical_03\b_overloading_math_crypto
npm install
npx ganache -p 8545
```
...
```bash
cd practical_03/b_overloading_math_crypto
npm install
npx ganache -p 8545
```
Then in Terminal 2:
