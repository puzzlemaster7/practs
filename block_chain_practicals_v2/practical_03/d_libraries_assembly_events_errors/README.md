# Practical 3(d): Libraries, Assembly, Events, Errors
...
## Description
Demonstrates advanced Solidity features used in real-world smart contracts.
...
**Terminal 1**
```powershell
cd G:\block_chain_practicals\practical_03\d_libraries_assembly_events_errors
npm install
npx ganache -p 8545
```
...
```bash
cd practical_03/d_libraries_assembly_events_errors
npm install
npx ganache -p 8545
```
Then in Terminal 2:
